  ...
  <div class="tableAll">
    <div class="tableMain">
      <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        <el-table-column prop="student_id.name" label="学生" width="180">
        </el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button slot="reference" style="margin-left: 10px"
                       @click="deleteSelclass(scope.row.id)" icon="el-icon-delete" type="danger" size="mini" circle>
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog style="width: 1000px;height: 1000px;" title="选课信息"
      ...
      <el-form ref="selclassInfo" :model="selclassInfo">
        ...
        <el-form-item label="学生" width="180px">
          <el-select v-model="selclassInfo.student_id" placeholder="学生">
            <el-option
    ...
    <div class="addArea">
      <el-button class="add_btn" type="primary" @click="openCreate">创建选课记录</el-button>
    </div>
...
<script type="text/javascript">
  ...
  import { getSelclassList, addSelclass, getSelclass, deleteSelclass, updateSelclass } from "@/api/selclass";
